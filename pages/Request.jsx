...
import { Bell, UploadCloud, CheckCircle } from "lucide-react";
...
export default function Request() {
  ...
  // User identity from localStorage (safe parse)
  ...
  const dropdownRef = useRef(null); // Profile Ref
...
const handleSubmit = async (e) => {
  ...
  if (!formData.agreed) {
    return alert("Please check the box to agree to terms.");
  }
  ...
  try {
    ...
    await axios.post(
      ...
      {
        patient_name: formData.recipientName,
    ...
    alert("Submission failed. Check your FastAPI console.");
  } finally {
    ...
    <div className="request-page">
      <header className="form-navbar">
        ...
        <div className="nav-right">
          ...
          {/* FIXED: Notification Bell with modern Dropdown */}
